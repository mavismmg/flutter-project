                    ...
                    children: [
                      ...
                      Container(
                        decoration: BoxDecoration(
                          ...
                          boxShadow: [
                            BoxShadow(
                              color: Colors.purple.withAlpha((255 * 0.08).toInt()),
                              blurRadius: 12,
                            ...
                            Padding(
                              ...
                              child: AnimatedOpacity(
                                opacity: viewModel.showMoodMessage &&
                                    ...
                                    : 0.0,
                                duration: const Duration(milliseconds: 400),
                                child: viewModel.showMoodMessage &&
                                        viewModel.lastMoodMessage.isNotEmpty
                                    ? Container(
      ...
      child: GestureDetector(
        ...
        child: AnimatedContainer(
          ...
          decoration: BoxDecoration(
            ...
            border: Border.all(
              color: checked ? Colors.purple : Colors.purple.withValues(alpha: 0.2),
              width: checked ? 2 : 1,
            ),
          ),
          child: Row(
  ...
  Widget build(BuildContext context) {
    return AnimatedContainer(
      ...
      decoration: BoxDecoration(
        ...
        border: Border.all(
          color: isSelected ? iconColor : Colors.black.withValues(alpha: 0.2),
